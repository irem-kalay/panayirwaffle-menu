...
export const menuCategoryList: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Filtre Kahve', description: 'Filtre kahve', price: '120 ₺', subcategory: 'Kahve Çeşitleri' },
      { name: 'Türk Kahvesi', description: 'Türk kahvesi', price: '120 ₺', subcategory: 'Kahve Çeşitleri' },
      { name: 'Ice Americano', description: 'Ice Americano', price: '120 ₺', subcategory: 'Soğuk Kahve Çeşitleri' },
      { name: 'Ice Latte (Karamel)', description: 'Ice Latte (Karamel)', price: '150 ₺', subcategory: 'Soğuk Kahve Çeşitleri' },
      { name: 'Ice Mocha', description: 'Ice Mocha', price: '180 ₺', subcategory: 'Soğuk Kahve Çeşitleri' },
      { name: 'Ice White Mocha', description: 'Ice White Mocha', price: '180 ₺', subcategory: 'Soğuk Kahve Çeşitleri' },
      { name: 'Ice Macchiato', description: 'Ice Macchiato', price: '120 ₺', subcategory: 'Soğuk Kahve Çeşitleri' },
      {
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Vanilyalı Milkshake', description: 'Vanilyalı Milkshake', price: '250 ₺', subcategory: 'Milkshake' },
      {
      ...
      { name: 'Çilekli Frozen', description: 'Çilekli Frozen', price: '250 ₺', subcategory: 'Frozen' },
      { name: 'Hindistan Cevizli Frozen', description: 'Hindistan Cevizli Frozen', price: '250 ₺', subcategory: 'Frozen' },
      { name: 'Sıcak Çikolata', description: 'Sıcak Çikolata', price: '150 ₺', subcategory: 'Sıcak İçecekler' },
      { name: 'Beyaz Çikolata', description: 'Beyaz Çikolata', price: '150 ₺', subcategory: 'Sıcak İçecekler' },
      { name: 'Salep', description: 'Salep', price: '120 ₺', subcategory: 'Sıcak İçecekler' },
      { name: 'Çay', description: 'Çay', price: '50 ₺', subcategory: 'Sıcak İçecekler' },
      { name: 'Kivi Çayı', description: 'Kivi Çayı', price: '50 ₺', subcategory: 'Sıcak İçecekler' },
      { name: 'Ev Yapımı Limonata', description: 'Ev Yapımı Limonata', price: '100 ₺', subcategory: 'Fresh İçecekler' },
      { name: 'Çilekli Limonata', description: 'Çilekli Limonata', price: '120 ₺', subcategory: 'Fresh İçecekler' },
      { name: 'Berry Hibiskus', description: 'Berry Hibiskus', price: '150 ₺', subcategory: 'Fresh İçecekler' },
      { name: 'Ihlamur Çayı', description: 'Ihlamur Çayı', price: '200 ₺', subcategory: 'Bitki Çayları' },
      { name: 'Kuşburnu Çayı', description: 'Kuşburnu Çayı', price: '200 ₺', subcategory: 'Bitki Çayları' },
      { name: 'Yeşil Çay', description: 'Yeşil Çay', price: '200 ₺', subcategory: 'Bitki Çayları' },
      { name: 'Ada Çayı', description: 'Ada Çayı', price: '200 ₺', subcategory: 'Bitki Çayları' },
      { name: 'Kış Çayı', description: 'Kış Çayı', price: '200 ₺', subcategory: 'Bitki Çayları' },
    ],
  },
];
